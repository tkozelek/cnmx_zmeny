<div class="w-full text-gray-200 bg-slate-900 shadow-md py-1">
    <div x-data="{ open: false }" @keydown.escape.window="open = false" class="flex flex-col container px-4 mx-auto md:items-center md:justify-between md:flex-row">
        <!-- Logo and burger -->
        <div class="p-2 flex flex-row items-center justify-between z-50">
            <x-application-logo/>
            <button class="md:hidden rounded-lg focus:outline-none focus:shadow-outline" @click="open = !open" aria-label="Toggle menu">
