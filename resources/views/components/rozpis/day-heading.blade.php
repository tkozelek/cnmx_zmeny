...
<div @class([
    'flex flex-col items-center justify-center border-b bg-neutral-900/60 px-4 py-3 text-center',
    'border-neutral-500' => $isToday,
    'border-neutral-800' => ! $isToday,
])>
    <p class="truncate text-lg font-bold text-neutral-100 max-w-full">{{ $name }}</p>
