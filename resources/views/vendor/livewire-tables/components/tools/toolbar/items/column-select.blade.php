        ...
        >
            <div>
                <span class="rounded-lg shadow-sm">
                    ...
                    >
                        <i class="fa-solid fa-table-columns text-xs text-brand-400"></i>
                        <span>Stĺpce</span>
            ...
            >
                <div class="space-y-1 text-sm text-neutral-200">
                    <div wire:key="{{ $tableName }}-columnSelect-selectAll-{{ rand(0,1000) }}">
                        <label class="flex items-center gap-2.5 rounded-lg px-2 py-1.5 hover:bg-neutral-800 cursor-pointer font-semibold text-brand-400">
                            <input
                                type="checkbox"
                                class="rounded border-neutral-700 bg-neutral-800 text-brand-500 focus:ring-brand-500"
