---
name: user-profile
description: "Who Tomáš is — role, background, communication style"
metadata: 
  node_type: memory
  type: user
...
He thinks at the architectural level — he gave a high-level brief and expected a complete, well-structured plan without hand-holding. He's comfortable with long, detailed technical documents when the content justifies it.

He works in Slovak/Czech context — the app UI and domain language is Slovak (Uvádzač, Bufet, Brigádnik, etc.).
